...
export default function FootScan() {
  ...
  const { user }    = useAuth()
  const refreshScan = useStore(s => s.refreshScan)
  const footNotes = useStore(s => s.footNotes)
  const saveFootNotes = useStore(s => s.saveFootNotes)
    ...
    async function process() {
      ...
      if (lidarData.right && lidarData.left) {
        ...
        const right = {
          ...
          ball_width:           R.right_ball_width           ?? null,
          heel_width:           R.right_heel_width           ?? null,
          heel_height:          R.right_heel_height          ?? null,
          ankle_width:          R.right_ankle_width          ?? null,
          ankle_height_medial:  R.right_ankle_height_medial  ?? null,
          ankle_height_lateral: R.right_ankle_height_lateral ?? null,
        ...
        const left = {
          ...
          ball_width:           L.left_ball_width           ?? null,
          heel_width:           L.left_heel_width           ?? null,
          heel_height:          L.left_heel_height          ?? null,
          ankle_width:          L.left_ankle_width          ?? null,
          ankle_height_medial:  L.left_ankle_height_medial  ?? null,
          ankle_height_lateral: L.left_ankle_height_lateral ?? null,
    ...
    async function save() {
      try {
        const payload = {
          ...
          ...(result.right.ball_width           != null && { right_ball_width:           result.right.ball_width }),
          ...(result.right.heel_width           != null && { right_heel_width:           result.right.heel_width }),
          ...(result.right.heel_height          != null && { right_heel_height:          result.right.heel_height }),
          ...(result.right.ankle_width          != null && { right_ankle_width:          result.right.ankle_width }),
          ...(result.right.ankle_height_medial  != null && { right_ankle_height_medial:  result.right.ankle_height_medial }),
          ...(result.right.ankle_height_lateral != null && { right_ankle_height_lateral: result.right.ankle_height_lateral }),
          ...(result.left.ball_width            != null && { left_ball_width:            result.left.ball_width }),
          ...(result.left.heel_width            != null && { left_heel_width:            result.left.heel_width }),
          ...(result.left.heel_height           != null && { left_heel_height:           result.left.heel_height }),
          ...(result.left.ankle_width           != null && { left_ankle_width:           result.left.ankle_width }),
          ...(result.left.ankle_height_medial   != null && { left_ankle_height_medial:   result.left.ankle_height_medial }),
          ...(result.left.ankle_height_lateral  != null && { left_ankle_height_lateral:  result.left.ankle_height_lateral }),
                    ...
                    <div key={label} className="border border-black/[0.06] overflow-hidden mb-4">
                      ...
                      <div className="grid grid-cols-2 gap-0">
                        {[
                          ...
                          { label: 'Ballenbreite',              key: 'ball_width',       value: m.ball_width,       optional: true },
                          { label: 'Fersenbreite',              key: 'heel_width',       value: m.heel_width,       optional: true },
                          { label: 'Fersenhöhe',                key: 'heel_height',      value: m.heel_height,      optional: true },
                          { label: 'Knöchelbreite',             key: 'ankle_width',      value: m.ankle_width,      optional: true },
                          { label: 'Knöchelhöhe innen',         key: 'ankle_height_medial',  value: m.ankle_height_medial,  optional: true },
                          { label: 'Knöchelhöhe außen',         key: 'ankle_height_lateral', value: m.ankle_height_lateral, optional: true },
