    ...
    <div className="min-h-full bg-white">
      ...
      <div className="px-5 lg:px-16 pb-20 border-t border-black/[0.07] pt-14">
        <Ablauf
          ...
          fuss="Ein maßgefertigter Schuh entsteht für einen bestimmten Fuß und ist danach für niemanden sonst zu gebrauchen — er ist vom Widerruf ausgenommen. Ist etwas mangelhaft, fertigen wir das Paar neu, ohne Kosten für Sie. Gefällt es Ihnen schlicht nicht, erstatten wir aus Kulanz bis zur Hälfte des Kaufpreises; dasselbe gilt bei einer Stornierung nach Fertigungsbeginn. Zubehör ist davon unberührt und geht innerhalb von 14 Tagen nach Zustellung vollständig zurück. Die Einzelheiten stehen in den AGB."
        />
      </div>
    </div>
  )
