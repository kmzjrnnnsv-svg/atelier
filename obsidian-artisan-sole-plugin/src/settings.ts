...
export class AtelierSettingTab extends PluginSettingTab {
  ...
  display(): void {
    ...
    containerEl.createEl("h2", { text: "Artisan Sole Einstellungen" });

    new Setting(containerEl)
      .setName("API URL")
      .setDesc("URL des Artisan Sole-Backends (z.B. http://localhost:3001)")
      .addText((text) =>
        text
    ...
    new Setting(containerEl)
      ...
      .addText((text) =>
        text
          .setPlaceholder("admin@artisansole.de")
    ...
    new Setting(containerEl)
      .setName("Sync-Ordner")
      .setDesc("Ordner im Vault, in dem Artisan Sole-Daten gespeichert werden")
      .addText((text) =>
        text
          .setPlaceholder("Artisan Sole")
    ...
    new Setting(containerEl)
      ...
      .setDesc("Prft die Verbindung zum Artisan Sole-Backend")
      .addButton((btn) =>
