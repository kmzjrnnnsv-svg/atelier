...
router.get('/robots.txt', (req, res) => {
  res.type('text/plain').send([
    ...
    'Disallow: /customize',
    '',
    '# Startseite zur Ansicht. Solange zwei Startseiten nebeneinander stehen,',
    '# gehoert nur eine in den Index — sonst konkurrieren sie um dieselben',
    '# Suchbegriffe. Die Seite traegt zusaetzlich ein noindex.',
