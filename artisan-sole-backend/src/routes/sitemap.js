...
router.get('/robots.txt', (req, res) => {
  res.type('text/plain').send([
    ...
    'Disallow: /customize',
    '',
    '# Dieselbe Seite wie /, nur unter einer zweiten Adresse zum Ausprobieren.',
    '# Zwei Adressen mit demselben Text konkurrieren um dieselben Suchbegriffe,',
    '# und die Suchmaschine entscheidet, welche gewinnt. Deshalb steht hier nur',
    '# / im Index; die Probeadresse traegt zusaetzlich ein noindex.',
    'Disallow: /test-homepage',
    '',
