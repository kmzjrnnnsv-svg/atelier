...
export function runMigrations(db) {
  ...
  db.exec(`
    ...
    INSERT OR IGNORE INTO loyalty_tiers (key, label, min_points, color, icon, description, benefits, visible, sort_order) VALUES
      ('bronze',    'Bronze',    0,     '#cd7f32', 'Award',    'Willkommen bei Artisan Sole. Als Bronze-Mitglied genießen Sie Zugang zu unserer exklusiven Kollektion von Custom Made Schuhen.', '["Zugang zur kompletten Kollektion","Persönliches Fußprofil mit 3D-Scan","Newsletter mit Styling-Tipps","Geburtstagsgruß"]', 1, 0),
      ...
      ('platinum',  'Platinum',  5000,  '#e5e4e2', 'Gem',      'Die höchste Auszeichnung für wahre Kenner. Platinum-Mitglieder genießen unvergleichliche Privilegien und persönlichen Service.', '["Alle Gold-Vorteile","Dedizierter Concierge-Service","20% auf alle Bestellungen","Kostenlose Reparaturen auf Lebenszeit","Zugang zu Limited Editions","Einladung zur jährlichen Gala","Custom Made Schuhspanner gratis"]', 1, 3),
