 ...
 * Matches the Dribbble reference: split help banner, 4-col links, bottom bar
 */
...
export default function Footer() {
  ...
  return (
    <footer>
      ...
      <div className="mx-4 lg:mx-16 xl:mx-24 overflow-hidden bg-[#2a2a2a]">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
            ...
            <div>
              ...
              <div className="space-y-2">
                <p className="text-[12px] text-white/35 font-light">+49 123 456 789</p>
                <p className="text-[12px] text-white/35 font-light">service@atelier.de</p>
              </div>
            </div>
            ...
            {/* Company */}
            <div>
              <p className="text-[11px] text-white/60 mb-4 font-normal">Unternehmen</p>
              <div className="space-y-2">
                {[
