...
export default function TopBar() {
  ...
  return (
    <>
      {/* ── Header bar ── */}
      <header className="border-b border-black/5 flex items-center justify-between px-4 h-12" style={{ position: 'sticky', top: 0, zIndex: 20, background: 'rgba(255,255,255,0.82)', backdropFilter: 'saturate(180%) blur(20px)', WebkitBackdropFilter: 'saturate(180%) blur(20px)' }}>
