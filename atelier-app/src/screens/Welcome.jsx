  ...
  return (
    <div className="flex flex-col min-h-full bg-white">
      ...
      <div className="flex justify-end px-5 pt-14 pb-2">
        {!isLast && (
          <button onClick={skip} className="text-xs text-gray-400 bg-transparent border-0 font-medium">
            Überspringen
          </button>
        )}
      </div>
      ...
      <div className="px-5 pb-10 space-y-6">
        ...
        <button
          onClick={next}
          className="w-full h-13 rounded-lg bg-black text-white font-semibold text-sm uppercase tracking-widest border-0 flex items-center justify-center gap-2"
          style={{ height: '52px' }}
        >
